    ...
    showSwal: function(type, that){
        ...
        if(type == 'basic'){
            ...
            swal({
                    ...
                    text: 'No sera posible recuperar la información despues de eliminar!',
                    type: 'warning',
                    showCancelButton: true,
                  ...
                  swal({
                    title: 'Eliminado!',
                    text: 'Elemento seleccionad eliminado correctamente.',
                    type: 'success',
                    confirmButtonClass: "btn btn-success",
                    buttonsStyling: false
                    })
        ...
        }else if(type == 'warning-message-and-cancel-quotas'){
            swal({
                    title: 'Esto agregara una cuota a cada miembro',
                    text: 'Esto generara un cargo por cada miembro',
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Si, agregar cuotas!',
                  ...
                  swal({
                    title: 'Agregadas!',
                    text: 'Cuota agregada a todos los miembros correctamente.',
                    type: 'success',
                    confirmButtonClass: "btn btn-success",
                    buttonsStyling: false
                    })
                  ...
                  if (dismiss === 'cancel') {
                    swal({
                      title: 'Cancelado',
                      text: 'No se ha agregado ningun cargo por concepto de cuotas :)',
                      type: 'error',
                      confirmButtonClass: "btn btn-info",
                      buttonsStyling: false
                    })
